...
def get_driver(retries: Optional[int] = None, timeout: Optional[int] = None) -> Optional[uc.Chrome]:
    """
    ...
    for attempt in range(retries):
        try:
            ...
            # Настройки загрузок и PDF для браузера
            prefs = {
                "download.default_directory": os.path.abspath(os.getenv("DOCUMENTS_DIR", os.path.join(os.getcwd(), "documents"))),
